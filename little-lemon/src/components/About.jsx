...
export const About = () => {
  return (
    <section className="grid grid-cols-1 md:grid-cols-12 gap-8 p-8 bg-white items-start">
      ...
      <div className="md:col-start-8 md:col-span-3 flex justify-center relative">
        <img src={chefB} alt="Chef Adrian" className="w-64 h-80 object-cover rounded-md z-10" />
        <img src={chefA} alt="Chef Mario" className="w-64 h-80 object-cover rounded-md absolute top-12 -left-20 shadow-lg" />
      </div>
    </section>
  );
};